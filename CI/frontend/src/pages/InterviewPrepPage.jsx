    ...
    <div style={{ minHeight:"100vh", background:"#050816", fontFamily:"'Inter','Outfit',sans-serif", color:"#e2e8f0", padding:"3rem 2rem" }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <header style={{ textAlign:"center", marginBottom:"3rem" }}>
          ...
          <h1 style={{ fontSize:"2.8rem", fontWeight:900, color:"#fff", margin:0, letterSpacing: "-1px" }}>Master Your Role</h1>
        </header>
            ...
            <motion.div key="active" initial={{ opacity:0, scale:0.98 }} animate={{ opacity:1, scale:1 }} exit={{ opacity:0, scale:0.95 }}
              ...
              <div style={{ marginBottom: "2.5rem" }}>
                {mode === "text" ? (
                  ...
                  <div style={{ position: "relative", width: "100%", height: "300px", borderRadius: "20px", overflow: "hidden", background: "#000", border: "1px solid rgba(255,255,255,0.1)" }}>
             ...
             <motion.div key="finish" initial={{ opacity:0, scale:0.95 }} animate={{ opacity:1, scale:1 }}
              style={{ background:"rgba(15,20,40,0.8)", border:"1px solid rgba(255,255,255,0.08)", borderRadius:"32px", padding:"4rem", textAlign:"center", backdropFilter:"blur(24px)", boxShadow: "0 25px 50px -12px rgba(0,0,0,0.5)" }}>
              ...
              <div style={{ display:"flex", gap:"1.5rem", justifyContent:"center" }}>
                <button onClick={() => navigate("/career-suggestions")} style={{ padding:"1.2rem 2.5rem", borderRadius:"18px", background:"rgba(255,255,255,0.04)", border:"1px solid rgba(255,255,255,0.1)", color:"#fff", fontWeight:700, cursor:"pointer", transition: "all 0.2s" }}>
                  Back to Dashboard
                </button>
